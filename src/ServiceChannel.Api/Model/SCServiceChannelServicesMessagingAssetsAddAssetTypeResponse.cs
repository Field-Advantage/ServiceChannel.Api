...
namespace ServiceChannel.Api.Model
{
    ...
    /// Add Trade Response
    /// </summary>
    [DataContract(Name = "ServiceChannel.Services.Messaging.Assets.AddAssetTypeResponse")]
    public partial class SCServiceChannelServicesMessagingAssetsAddAssetTypeResponse : IEquatable<SCServiceChannelServicesMessagingAssetsAddAssetTypeResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SCServiceChannelServicesMessagingAssetsAddAssetTypeResponse" /> class.
        /// </summary>
        ...
        public SCServiceChannelServicesMessagingAssetsAddAssetTypeResponse(int id = default(int), int errorCode = default(int), string message = default(string))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as SCServiceChannelServicesMessagingAssetsAddAssetTypeResponse);
        }

        /// <summary>
        /// Returns true if SCServiceChannelServicesMessagingAssetsAddAssetTypeResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SCServiceChannelServicesMessagingAssetsAddAssetTypeResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SCServiceChannelServicesMessagingAssetsAddAssetTypeResponse input)
        {
            if (input == null)
            {
                return false;
