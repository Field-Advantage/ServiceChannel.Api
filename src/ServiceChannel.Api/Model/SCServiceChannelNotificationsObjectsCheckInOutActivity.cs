...
{
    /// <summary>
    /// SCServiceChannelNotificationsObjectsCheckInOutActivity
    /// </summary>
    [DataContract(Name = "ServiceChannel.Notifications.Objects.CheckInOutActivity")]
    public partial class SCServiceChannelNotificationsObjectsCheckInOutActivity : IEquatable<SCServiceChannelNotificationsObjectsCheckInOutActivity>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SCServiceChannelNotificationsObjectsCheckInOutActivity" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SCServiceChannelNotificationsObjectsCheckInOutActivity);
        }

        /// <summary>
        /// Returns true if SCServiceChannelNotificationsObjectsCheckInOutActivity instances are equal
        /// </summary>
        /// <param name="input">Instance of SCServiceChannelNotificationsObjectsCheckInOutActivity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SCServiceChannelNotificationsObjectsCheckInOutActivity input)
        {
            if (input == null)
            {
                return false;
