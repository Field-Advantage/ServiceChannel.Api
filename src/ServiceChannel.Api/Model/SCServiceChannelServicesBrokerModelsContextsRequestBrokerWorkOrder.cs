...
{
    /// <summary>
    /// SCServiceChannelServicesBrokerModelsContextsRequestBrokerWorkOrder
    /// </summary>
    [DataContract(Name = "ServiceChannel.Services.Broker.Models.Contexts.Request.BrokerWorkOrder")]
    public partial class SCServiceChannelServicesBrokerModelsContextsRequestBrokerWorkOrder : IEquatable<SCServiceChannelServicesBrokerModelsContextsRequestBrokerWorkOrder>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SCServiceChannelServicesBrokerModelsContextsRequestBrokerWorkOrder" /> class.
        /// </summary>
        /// <param name="originationUserName">originationUserName.</param>
        ...
        /// <summary>
        /// Gets or Sets OriginationUserName
        /// </summary>
        [DataMember(Name = "OriginationUserName", EmitDefaultValue = false)]
        public string OriginationUserName { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SCServiceChannelServicesBrokerModelsContextsRequestBrokerWorkOrder {\n");
            sb.Append("  OriginationUserName: ").Append(OriginationUserName).Append("\n");
        ...
        {
            return this.Equals(input as SCServiceChannelServicesBrokerModelsContextsRequestBrokerWorkOrder);
        }

        /// <summary>
        /// Returns true if SCServiceChannelServicesBrokerModelsContextsRequestBrokerWorkOrder instances are equal
        /// </summary>
        /// <param name="input">Instance of SCServiceChannelServicesBrokerModelsContextsRequestBrokerWorkOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SCServiceChannelServicesBrokerModelsContextsRequestBrokerWorkOrder input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.OriginationUserName == input.OriginationUserName ||
                    (this.OriginationUserName != null &&
                    this.OriginationUserName.Equals(input.OriginationUserName))
                ) && 
                (
                    this.Id == input.Id ||
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.OriginationUserName != null)
                {
                    hashCode = (hashCode * 59) + this.OriginationUserName.GetHashCode();
                }
