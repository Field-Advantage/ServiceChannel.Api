...
{
    /// <summary>
    /// SCServiceChannelServicesMessagingPartsRefrigerantUsageResponse
    /// </summary>
    [DataContract(Name = "ServiceChannel.Services.Messaging.Parts.RefrigerantUsageResponse")]
    public partial class SCServiceChannelServicesMessagingPartsRefrigerantUsageResponse : IEquatable<SCServiceChannelServicesMessagingPartsRefrigerantUsageResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SCServiceChannelServicesMessagingPartsRefrigerantUsageResponse" /> class.
        /// </summary>
        /// <param name="triggerQuantity">triggerQuantity.</param>
        /// <param name="leakRate">leakRate.</param>
        /// <param name="charge">charge.</param>
        /// <param name="calculationMethod">calculationMethod.</param>
        public SCServiceChannelServicesMessagingPartsRefrigerantUsageResponse(double triggerQuantity = default(double), double leakRate = default(double), double charge = default(double), byte[] calculationMethod = default(byte[]))
        {
        ...
        /// </summary>
        [DataMember(Name = "LeakRate", EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as SCServiceChannelServicesMessagingPartsRefrigerantUsageResponse);
        }

        /// <summary>
        /// Returns true if SCServiceChannelServicesMessagingPartsRefrigerantUsageResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SCServiceChannelServicesMessagingPartsRefrigerantUsageResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SCServiceChannelServicesMessagingPartsRefrigerantUsageResponse input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.LeakRate == input.LeakRate ||
                    this.LeakRate.Equals(input.LeakRate)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.LeakRate.GetHashCode();
