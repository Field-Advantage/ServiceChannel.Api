...
{
    /// <summary>
    /// SCServiceChannelServicesMessagingInvoicesInvoiceApprovalCode
    /// </summary>
    [DataContract(Name = "ServiceChannel.Services.Messaging.Invoices.InvoiceApprovalCode")]
    public partial class SCServiceChannelServicesMessagingInvoicesInvoiceApprovalCode : IEquatable<SCServiceChannelServicesMessagingInvoicesInvoiceApprovalCode>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SCServiceChannelServicesMessagingInvoicesInvoiceApprovalCode" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SCServiceChannelServicesMessagingInvoicesInvoiceApprovalCode);
        }

        /// <summary>
        /// Returns true if SCServiceChannelServicesMessagingInvoicesInvoiceApprovalCode instances are equal
        /// </summary>
        /// <param name="input">Instance of SCServiceChannelServicesMessagingInvoicesInvoiceApprovalCode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SCServiceChannelServicesMessagingInvoicesInvoiceApprovalCode input)
        {
            if (input == null)
            {
                return false;
