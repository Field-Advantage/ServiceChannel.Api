...
namespace ServiceChannel.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ServiceChannel.Services.Messaging.Assets.AddAssetRequest")]
    public partial class SCServiceChannelServicesMessagingAssetsAddAssetRequest : IEquatable<SCServiceChannelServicesMessagingAssetsAddAssetRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SCServiceChannelServicesMessagingAssetsAddAssetRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SCServiceChannelServicesMessagingAssetsAddAssetRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SCServiceChannelServicesMessagingAssetsAddAssetRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SCServiceChannelServicesMessagingAssetsAddAssetRequest);
        }

        /// <summary>
        /// Returns true if SCServiceChannelServicesMessagingAssetsAddAssetRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SCServiceChannelServicesMessagingAssetsAddAssetRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SCServiceChannelServicesMessagingAssetsAddAssetRequest input)
        {
            if (input == null)
            {
                return false;
