...
namespace ServiceChannel.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ServiceChannel.Services.Messaging.Assets.AssetAttachment")]
    public partial class SCServiceChannelServicesMessagingAssetsAssetAttachment : IEquatable<SCServiceChannelServicesMessagingAssetsAssetAttachment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SCServiceChannelServicesMessagingAssetsAssetAttachment" /> class.
        /// </summary>
        ...
        public SCServiceChannelServicesMessagingAssetsAssetAttachment(int id = default(int), int assetId = default(int), string fileName = default(string), string comment = default(string), DateTime date = default(DateTime), string filePath = default(string), bool isPrimary = false, string uri = default(string), string thumbnailPath = default(string), string thumbnailUri = default(string))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as SCServiceChannelServicesMessagingAssetsAssetAttachment);
        }

        /// <summary>
        /// Returns true if SCServiceChannelServicesMessagingAssetsAssetAttachment instances are equal
        /// </summary>
        /// <param name="input">Instance of SCServiceChannelServicesMessagingAssetsAssetAttachment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SCServiceChannelServicesMessagingAssetsAssetAttachment input)
        {
            if (input == null)
            {
                return false;
