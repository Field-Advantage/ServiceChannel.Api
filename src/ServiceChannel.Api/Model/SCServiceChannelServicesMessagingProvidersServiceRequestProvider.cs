...
{
    /// <summary>
    /// SCServiceChannelServicesMessagingProvidersServiceRequestProvider
    /// </summary>
    [DataContract(Name = "ServiceChannel.Services.Messaging.Providers.ServiceRequestProvider")]
    public partial class SCServiceChannelServicesMessagingProvidersServiceRequestProvider : IEquatable<SCServiceChannelServicesMessagingProvidersServiceRequestProvider>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SCServiceChannelServicesMessagingProvidersServiceRequestProvider" /> class.
        /// </summary>
        /// <param name="rank">Rank.</param>
        /// <param name="category">Category.</param>
        /// <param name="priority">Priority.</param>
        /// <param name="nte">Nte.</param>
        /// <param name="generalEmail">General Email.</param>
        /// <param name="isDefault">Is Default (default to false).</param>
        /// <param name="serviceRequestEmails">ServiceRequestEmails.</param>
        ...
        public SCServiceChannelServicesMessagingProvidersServiceRequestProvider(int rank = default(int), string category = default(string), string priority = default(string), double nte = default(double), string generalEmail = default(string), bool isDefault = false, string serviceRequestEmails = default(string), string phone = default(string), string fullName = default(string), string address1 = default(string), string address2 = default(string), string city = default(string), string state = default(string), string zip = default(string), string country = default(string), string mainContact = default(string), DateTime dateCreated = default(DateTime), string lastUserDate = default(string), string superUser = default(string), string webSite = default(string), string email = default(string), string taxId = default(string), string trade = default(string), string processingEmail = default(string), string faxNumber = default(string), string suiteFloor = default(string), string mailInfo = default(string), string imageFile = default(string), string returnMail = default(string), int mailFrequency = default(int), int formId = default(int), string pager = default(string), int nightRequest = default(int), string shortFormatEmail = default(string), DateTime lastTrainingDate = default(DateTime), string lastTrainingDateStr = default(string), bool isInternal = false, bool isOnOffShoreFeatureEnabled = false, int id = default(int), string name = default(string), bool doNotDispatch = false)
        {
            ...
            this.ServiceRequestEmails = serviceRequestEmails;
            this.Phone = phone;
        ...
        [DataMember(Name = "GeneralEmail", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>ServiceRequestEmails</value>
        [DataMember(Name = "ServiceRequestEmails", EmitDefaultValue = false)]
        public string ServiceRequestEmails { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SCServiceChannelServicesMessagingProvidersServiceRequestProvider {\n");
            sb.Append("  Rank: ").Append(Rank).Append("\n");
            sb.Append("  Category: ").Append(Category).Append("\n");
            sb.Append("  Priority: ").Append(Priority).Append("\n");
            sb.Append("  Nte: ").Append(Nte).Append("\n");
            sb.Append("  GeneralEmail: ").Append(GeneralEmail).Append("\n");
            sb.Append("  IsDefault: ").Append(IsDefault).Append("\n");
            sb.Append("  ServiceRequestEmails: ").Append(ServiceRequestEmails).Append("\n");
        ...
        {
            return this.Equals(input as SCServiceChannelServicesMessagingProvidersServiceRequestProvider);
        }

        /// <summary>
        /// Returns true if SCServiceChannelServicesMessagingProvidersServiceRequestProvider instances are equal
        /// </summary>
        /// <param name="input">Instance of SCServiceChannelServicesMessagingProvidersServiceRequestProvider to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SCServiceChannelServicesMessagingProvidersServiceRequestProvider input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.GeneralEmail == input.GeneralEmail ||
                    (this.GeneralEmail != null &&
                    this.GeneralEmail.Equals(input.GeneralEmail))
                ) && 
                (
                ...
                (
                    this.ServiceRequestEmails == input.ServiceRequestEmails ||
                    (this.ServiceRequestEmails != null &&
                    this.ServiceRequestEmails.Equals(input.ServiceRequestEmails))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.GeneralEmail != null)
                {
                    hashCode = (hashCode * 59) + this.GeneralEmail.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.IsDefault.GetHashCode();
                if (this.ServiceRequestEmails != null)
                {
                    hashCode = (hashCode * 59) + this.ServiceRequestEmails.GetHashCode();
                }
                if (this.Phone != null)
                {
