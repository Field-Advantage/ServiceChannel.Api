...
namespace ServiceChannel.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ServiceChannel.Services.Messaging.CheckListDetails.CheckListDetailQuestionsResponse")]
    public partial class SCServiceChannelServicesMessagingCheckListDetailsCheckListDetailQuestionsResponse : IEquatable<SCServiceChannelServicesMessagingCheckListDetailsCheckListDetailQuestionsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SCServiceChannelServicesMessagingCheckListDetailsCheckListDetailQuestionsResponse" /> class.
        /// </summary>
        ...
        public SCServiceChannelServicesMessagingCheckListDetailsCheckListDetailQuestionsResponse(int id = default(int), int checkListId = default(int), string question = default(string), string shortDescription = default(string), bool answerRequired = false, PictureFlagEnum? pictureFlag = default(PictureFlagEnum?), int sequence = default(int), QuestionTypeEnum? questionType = default(QuestionTypeEnum?), List<SCServiceChannelServicesMessagingCheckListDetailsCheckListQuestionOptionResponse> checkListQuestionOptions = default(List<SCServiceChannelServicesMessagingCheckListDetailsCheckListQuestionOptionResponse>), bool answerCanPersist = false, CheckListTimingTypeEnum? checkListTimingType = default(CheckListTimingTypeEnum?))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as SCServiceChannelServicesMessagingCheckListDetailsCheckListDetailQuestionsResponse);
        }

        /// <summary>
        /// Returns true if SCServiceChannelServicesMessagingCheckListDetailsCheckListDetailQuestionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SCServiceChannelServicesMessagingCheckListDetailsCheckListDetailQuestionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SCServiceChannelServicesMessagingCheckListDetailsCheckListDetailQuestionsResponse input)
        {
            if (input == null)
            {
                return false;
