...
{
    /// <summary>
    /// SCServiceChannelServicesMessagingLocationUpdateLandlordResponsibilityApiRequest
    /// </summary>
    [DataContract(Name = "ServiceChannel.Services.Messaging.Location.UpdateLandlordResponsibilityApiRequest")]
    public partial class SCServiceChannelServicesMessagingLocationUpdateLandlordResponsibilityApiRequest : IEquatable<SCServiceChannelServicesMessagingLocationUpdateLandlordResponsibilityApiRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SCServiceChannelServicesMessagingLocationUpdateLandlordResponsibilityApiRequest" /> class.
        /// </summary>
        ...
        public SCServiceChannelServicesMessagingLocationUpdateLandlordResponsibilityApiRequest(int id = default(int), string tradeName = default(string), string categoryName = default(string), string overridePriorityName = default(string), string overrideCategoryName = default(string), string overrideProviderRank = default(string), string overrideNTE = default(string), string leaseNote = default(string))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as SCServiceChannelServicesMessagingLocationUpdateLandlordResponsibilityApiRequest);
        }

        /// <summary>
        /// Returns true if SCServiceChannelServicesMessagingLocationUpdateLandlordResponsibilityApiRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SCServiceChannelServicesMessagingLocationUpdateLandlordResponsibilityApiRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SCServiceChannelServicesMessagingLocationUpdateLandlordResponsibilityApiRequest input)
        {
            if (input == null)
            {
                return false;
