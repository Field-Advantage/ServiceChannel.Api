...
namespace ServiceChannel.Api.Model
{
    ...
    /// Holds response.
    /// </summary>
    [DataContract(Name = "ServiceChannel.Services.Messaging.ApprovalCodes.GetApprovalCodesWithOptionsResponse")]
    public partial class SCServiceChannelServicesMessagingApprovalCodesGetApprovalCodesWithOptionsResponse : IEquatable<SCServiceChannelServicesMessagingApprovalCodesGetApprovalCodesWithOptionsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SCServiceChannelServicesMessagingApprovalCodesGetApprovalCodesWithOptionsResponse" /> class.
        /// </summary>
        /// <param name="approvalCodes">Gets or sets ApprovalCodes..</param>
        ...
        public SCServiceChannelServicesMessagingApprovalCodesGetApprovalCodesWithOptionsResponse(List<SCServiceChannelApiModelEntitiesApprovalCodesApprovalCodeWithOptions> approvalCodes = default(List<SCServiceChannelApiModelEntitiesApprovalCodesApprovalCodeWithOptions>), int errorCode = default(int), string message = default(string))
        {
        ...
        {
            return this.Equals(input as SCServiceChannelServicesMessagingApprovalCodesGetApprovalCodesWithOptionsResponse);
        }

        /// <summary>
        /// Returns true if SCServiceChannelServicesMessagingApprovalCodesGetApprovalCodesWithOptionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SCServiceChannelServicesMessagingApprovalCodesGetApprovalCodesWithOptionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SCServiceChannelServicesMessagingApprovalCodesGetApprovalCodesWithOptionsResponse input)
        {
            if (input == null)
            {
                return false;
