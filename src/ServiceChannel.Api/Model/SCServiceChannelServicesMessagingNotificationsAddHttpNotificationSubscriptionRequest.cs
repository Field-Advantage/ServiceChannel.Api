...
{
    /// <summary>
    /// SCServiceChannelServicesMessagingNotificationsAddHttpNotificationSubscriptionRequest
    /// </summary>
    [DataContract(Name = "ServiceChannel.Services.Messaging.Notifications.AddHttpNotificationSubscriptionRequest")]
    public partial class SCServiceChannelServicesMessagingNotificationsAddHttpNotificationSubscriptionRequest : IEquatable<SCServiceChannelServicesMessagingNotificationsAddHttpNotificationSubscriptionRequest>, IValidatableObject
    {
        /// <summary>
        /// Defines EventTypes
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SCServiceChannelServicesMessagingNotificationsAddHttpNotificationSubscriptionRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SCServiceChannelServicesMessagingNotificationsAddHttpNotificationSubscriptionRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SCServiceChannelServicesMessagingNotificationsAddHttpNotificationSubscriptionRequest" /> class.
        /// </summary>
        ...
        public SCServiceChannelServicesMessagingNotificationsAddHttpNotificationSubscriptionRequest(string url = default(string), bool enabled = false, string name = default(string), List<EventTypesEnum> eventTypes = default(List<EventTypesEnum>), SCServiceChannelServicesMessagingNotificationsNotificationSubscriptionsRules rules = default(SCServiceChannelServicesMessagingNotificationsNotificationSubscriptionsRules))
        {
            // to ensure "url" is required (not null)
            if (url == null)
            {
                throw new ArgumentNullException("url is a required property for SCServiceChannelServicesMessagingNotificationsAddHttpNotificationSubscriptionRequest and cannot be null");
            }
            this.Url = url;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for SCServiceChannelServicesMessagingNotificationsAddHttpNotificationSubscriptionRequest and cannot be null");
            }
            this.Name = name;
            // to ensure "eventTypes" is required (not null)
            if (eventTypes == null)
            {
                throw new ArgumentNullException("eventTypes is a required property for SCServiceChannelServicesMessagingNotificationsAddHttpNotificationSubscriptionRequest and cannot be null");
            }
        ...
        public List<SCServiceChannelServicesMessagingNotificationsAddHttpNotificationSubscriptionRequest.EventTypesEnum> EventTypes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SCServiceChannelServicesMessagingNotificationsAddHttpNotificationSubscriptionRequest {\n");
        ...
        {
            return this.Equals(input as SCServiceChannelServicesMessagingNotificationsAddHttpNotificationSubscriptionRequest);
        }

        /// <summary>
        /// Returns true if SCServiceChannelServicesMessagingNotificationsAddHttpNotificationSubscriptionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SCServiceChannelServicesMessagingNotificationsAddHttpNotificationSubscriptionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SCServiceChannelServicesMessagingNotificationsAddHttpNotificationSubscriptionRequest input)
        {
            if (input == null)
            {
                return false;
