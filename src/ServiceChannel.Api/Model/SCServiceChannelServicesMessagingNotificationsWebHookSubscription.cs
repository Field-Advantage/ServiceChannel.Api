...
{
    /// <summary>
    /// SCServiceChannelServicesMessagingNotificationsWebHookSubscription
    /// </summary>
    [DataContract(Name = "ServiceChannel.Services.Messaging.Notifications.WebHookSubscription")]
    public partial class SCServiceChannelServicesMessagingNotificationsWebHookSubscription : IEquatable<SCServiceChannelServicesMessagingNotificationsWebHookSubscription>, IValidatableObject
    {
        /// <summary>
        /// Defines EventTypes
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SCServiceChannelServicesMessagingNotificationsWebHookSubscription" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SCServiceChannelServicesMessagingNotificationsWebHookSubscription() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SCServiceChannelServicesMessagingNotificationsWebHookSubscription" /> class.
        /// </summary>
        ...
        public SCServiceChannelServicesMessagingNotificationsWebHookSubscription(int id = default(int), string name = default(string), List<EventTypesEnum> eventTypes = default(List<EventTypesEnum>), SCServiceChannelServicesMessagingNotificationsNotificationSubscriptionsRules rules = default(SCServiceChannelServicesMessagingNotificationsNotificationSubscriptionsRules))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for SCServiceChannelServicesMessagingNotificationsWebHookSubscription and cannot be null");
            }
            this.Name = name;
            // to ensure "eventTypes" is required (not null)
            if (eventTypes == null)
            {
                throw new ArgumentNullException("eventTypes is a required property for SCServiceChannelServicesMessagingNotificationsWebHookSubscription and cannot be null");
            }
        ...
        public List<SCServiceChannelServicesMessagingNotificationsWebHookSubscription.EventTypesEnum> EventTypes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SCServiceChannelServicesMessagingNotificationsWebHookSubscription {\n");
        ...
        {
            return this.Equals(input as SCServiceChannelServicesMessagingNotificationsWebHookSubscription);
        }

        /// <summary>
        /// Returns true if SCServiceChannelServicesMessagingNotificationsWebHookSubscription instances are equal
        /// </summary>
        /// <param name="input">Instance of SCServiceChannelServicesMessagingNotificationsWebHookSubscription to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SCServiceChannelServicesMessagingNotificationsWebHookSubscription input)
        {
            if (input == null)
            {
                return false;
