...
{
    /// <summary>
    /// SCServiceChannelServicesMessagingAssetsAddAssetTypeGroupAttachmentResponse
    /// </summary>
    [DataContract(Name = "ServiceChannel.Services.Messaging.Assets.AddAssetTypeGroupAttachmentResponse")]
    public partial class SCServiceChannelServicesMessagingAssetsAddAssetTypeGroupAttachmentResponse : IEquatable<SCServiceChannelServicesMessagingAssetsAddAssetTypeGroupAttachmentResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SCServiceChannelServicesMessagingAssetsAddAssetTypeGroupAttachmentResponse" /> class.
        /// </summary>
        ...
        public SCServiceChannelServicesMessagingAssetsAddAssetTypeGroupAttachmentResponse(bool isSuccess = false, string message = default(string), int id = default(int), int subscriberId = default(int), string name = default(string), string fileName = default(string), string filePath = default(string), string thumbnailPath = default(string), List<int> assetTypeIds = default(List<int>), string uri = default(string), string thumbnailUri = default(string), int assetTypeCategoryId = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SCServiceChannelServicesMessagingAssetsAddAssetTypeGroupAttachmentResponse {\n");
        ...
        {
            return this.Equals(input as SCServiceChannelServicesMessagingAssetsAddAssetTypeGroupAttachmentResponse);
        }

        /// <summary>
        /// Returns true if SCServiceChannelServicesMessagingAssetsAddAssetTypeGroupAttachmentResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SCServiceChannelServicesMessagingAssetsAddAssetTypeGroupAttachmentResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SCServiceChannelServicesMessagingAssetsAddAssetTypeGroupAttachmentResponse input)
        {
            if (input == null)
            {
                return false;
