...
namespace ServiceChannel.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ServiceChannel.Services.Messaging.ChecklistTasks.CheckListWithTasksResponse")]
    public partial class SCServiceChannelServicesMessagingChecklistTasksCheckListWithTasksResponse : IEquatable<SCServiceChannelServicesMessagingChecklistTasksCheckListWithTasksResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SCServiceChannelServicesMessagingChecklistTasksCheckListWithTasksResponse" /> class.
        /// </summary>
        ...
        /// <param name="tasks">A list of asset-related tasks configured for the checklist..</param>
        public SCServiceChannelServicesMessagingChecklistTasksCheckListWithTasksResponse(string checklistName = default(string), int id = default(int), bool isActive = false, DateTime createdDate = default(DateTime), DateTime updatedDate = default(DateTime), int createdBy = default(int), int updatedBy = default(int), List<SCServiceChannelServicesMessagingChecklistTasksChecklistTaskResponse> tasks = default(List<SCServiceChannelServicesMessagingChecklistTasksChecklistTaskResponse>))
        {
        ...
        {
            return this.Equals(input as SCServiceChannelServicesMessagingChecklistTasksCheckListWithTasksResponse);
        }

        /// <summary>
        /// Returns true if SCServiceChannelServicesMessagingChecklistTasksCheckListWithTasksResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SCServiceChannelServicesMessagingChecklistTasksCheckListWithTasksResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SCServiceChannelServicesMessagingChecklistTasksCheckListWithTasksResponse input)
        {
            if (input == null)
            {
                return false;
