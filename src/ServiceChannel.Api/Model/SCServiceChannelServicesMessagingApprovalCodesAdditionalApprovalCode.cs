...
{
    /// <summary>
    /// SCServiceChannelServicesMessagingApprovalCodesAdditionalApprovalCode
    /// </summary>
    [DataContract(Name = "ServiceChannel.Services.Messaging.ApprovalCodes.AdditionalApprovalCode")]
    public partial class SCServiceChannelServicesMessagingApprovalCodesAdditionalApprovalCode : IEquatable<SCServiceChannelServicesMessagingApprovalCodesAdditionalApprovalCode>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SCServiceChannelServicesMessagingApprovalCodesAdditionalApprovalCode" /> class.
        /// </summary>
        ...
        public SCServiceChannelServicesMessagingApprovalCodesAdditionalApprovalCode(string header = default(string), string value = default(string), int setupId = default(int), int locationId = default(int), int defaultOptionId = default(int), int valueFormat = default(int), int editableAtLineItemLevel = default(int), List<SCServiceChannelServicesMessagingApprovalCodesAdditionalApprovalCodeOption> options = default(List<SCServiceChannelServicesMessagingApprovalCodesAdditionalApprovalCodeOption>))
        {
            this.Header = header;
            this.Value = value;
        ...
        {
            return this.Equals(input as SCServiceChannelServicesMessagingApprovalCodesAdditionalApprovalCode);
        }

        /// <summary>
        /// Returns true if SCServiceChannelServicesMessagingApprovalCodesAdditionalApprovalCode instances are equal
        /// </summary>
        /// <param name="input">Instance of SCServiceChannelServicesMessagingApprovalCodesAdditionalApprovalCode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SCServiceChannelServicesMessagingApprovalCodesAdditionalApprovalCode input)
        {
            if (input == null)
            {
                return false;
