...
namespace ServiceChannel.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ServiceChannel.Services.Messaging.Users.UpdateUserRequest")]
    public partial class SCServiceChannelServicesMessagingUsersUpdateUserRequest : IEquatable<SCServiceChannelServicesMessagingUsersUpdateUserRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SCServiceChannelServicesMessagingUsersUpdateUserRequest" /> class.
        /// </summary>
        ...
        public SCServiceChannelServicesMessagingUsersUpdateUserRequest(int id = default(int), int infoSubscriberId = default(int), string userName = default(string), string password = default(string), string email = default(string), string locationAccess = default(string), string feedRole = default(string), SCServiceChannelServicesMessagingUsersUser user = default(SCServiceChannelServicesMessagingUsersUser))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SCServiceChannelServicesMessagingUsersUpdateUserRequest {\n");
        ...
        {
            return this.Equals(input as SCServiceChannelServicesMessagingUsersUpdateUserRequest);
        }

        /// <summary>
        /// Returns true if SCServiceChannelServicesMessagingUsersUpdateUserRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SCServiceChannelServicesMessagingUsersUpdateUserRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SCServiceChannelServicesMessagingUsersUpdateUserRequest input)
        {
            if (input == null)
            {
                return false;
