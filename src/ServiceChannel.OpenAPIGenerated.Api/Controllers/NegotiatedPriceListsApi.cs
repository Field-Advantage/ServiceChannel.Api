...
{ 
    ...
    /// </summary>
    [ApiController]
    public abstract class NegotiatedPriceListsApiController : ControllerBase
    { 
        /// <summary>
        /// Get negotiated pricelists
        /// </summary>
        /// <param name="priceListName">Unique Price List Identifier</param>
        /// <param name="providerId">Unique Provider Identifier</param>
        /// <param name="locationId">Unique Location Identifier</param>
        /// <param name="applyDatesFilter">true: Current date between priceList.EffectiveDate and priceList.ExpirationDate; false: date filter is disabled</param>
        /// <param name="isReturnDeleted">Return deleted items PriceList Parts and PriceList Other Charges</param>
        ...
        [HttpGet]
        [Route("/v3/negotiatedpricelists/negotiatedpricelists")]
        [ValidateModelState]
        [ProducesResponseType(statusCode: 200, type: typeof(SCServiceChannelServicesMessagingNegotiatedPriceListNegotiatedPriceList))]
        ...
        public abstract Task<IActionResult> NegotiatedpricelistsNegotiatedpricelistspriceListNamepriceListNameproviderIdproviderIdlocationIdlocationIdapplyDatesFilterapplyDatesFilterisReturnDeletedisReturnDeleted([FromQuery (Name = "priceListName")]string? priceListName, [FromQuery (Name = "providerId")]int? providerId, [FromQuery (Name = "locationId")]int? locationId, [FromQuery (Name = "applyDatesFilter")]bool? applyDatesFilter, [FromQuery (Name = "isReturnDeleted")]bool? isReturnDeleted);
    }
}
