...
{ 
    ...
    { 
        ...
        /// <response code="400">Bad Request - the request could not be understood or was missing required parameters.              &lt;br/&gt;Error codes:              &lt;br/&gt; 503 - User info should not be null;              &lt;br/&gt;ProviderId is null;</response>
        ...
        [ValidateModelState]
        [ProducesResponseType(statusCode: 200, type: typeof(SCServiceChannelServicesMessagingAnnouncementsGetUserAnnouncementsResponse))]
        ...
        public abstract Task<IActionResult> Announcements();
        ...
        /// <response code="401">Unauthorized indicates that the requested resource requires authentication.              &lt;br/&gt;Error codes:              &lt;br/&gt; 504 - API call rejected by security permissions;</response>
        [HttpPut]
        [Route("/v3/announcements/{messageId}")]
        [ValidateModelState]
        [ProducesResponseType(statusCode: 200, type: typeof(bool))]
        [ProducesResponseType(statusCode: 400, type: typeof(SCServiceChannelServicesMessagingErrorResponse))]
        [ProducesResponseType(statusCode: 401, type: typeof(SCServiceChannelServicesMessagingErrorResponse))]
        public abstract Task<IActionResult> AnnouncementsmessageId([FromRoute (Name = "messageId")][Required]int messageId);
    }
}
