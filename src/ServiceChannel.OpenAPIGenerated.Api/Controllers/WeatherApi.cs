...
{ 
    ...
    /// </summary>
    [ApiController]
    public abstract class WeatherApiController : ControllerBase
    { 
        /// <summary>
        ...
        [HttpGet]
        [Route("/v3/weather/eventTypes")]
        [ValidateModelState]
        [ProducesResponseType(statusCode: 200, type: typeof(List<SCServiceChannelApiModelWorkordersWeatherEventType>))]
        ...
        public abstract Task<IActionResult> WeatherEventTypessubscriberIdsubscriberId([FromQuery (Name = "subscriberId")]int? subscriberId);
        ...
        /// <response code="401">Indicates that the requested resource requires authentication.              &lt;br&gt;Error codes:              &lt;br&gt; 504 - API call rejected by security permissions;</response>
        [HttpGet]
        [Route("/v3/weather/subscribers")]
        [ValidateModelState]
        [ProducesResponseType(statusCode: 200, type: typeof(Object))]
        [ProducesResponseType(statusCode: 400, type: typeof(SCServiceChannelServicesMessagingErrorResponse))]
        [ProducesResponseType(statusCode: 401, type: typeof(SCServiceChannelServicesMessagingErrorResponse))]
        public abstract Task<IActionResult> WeatherSubscribers();
    }
}
