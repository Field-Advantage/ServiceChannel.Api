...
{ 
    ...
    /// </summary>
    [ApiController]
    public abstract class MonitoringApiController : ControllerBase
    { 
        /// <summary>
        ...
        [HttpGet]
        [Route("/v3/monitoring/CheckStorageAvalaibility")]
        [ValidateModelState]
        [ProducesResponseType(statusCode: 200, type: typeof(Object))]
        public abstract Task<IActionResult> MonitoringCheckStorageAvalaibility();
    }
}
