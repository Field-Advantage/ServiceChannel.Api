...
{ 
    ...
    /// </summary>
    [ApiController]
    public abstract class AssetTaskResponseApiController : ControllerBase
    { 
        /// <summary>
        ...
        [HttpGet]
        [Route("/v3/workorders/{workOrderId}/asset-tasks")]
        [ValidateModelState]
        ...
        public abstract Task<IActionResult> WorkordersworkOrderIdAssetTasks([FromRoute (Name = "workOrderId")][Required]int workOrderId);
        ...
        /// <response code="500">Indicates that a generic error has occurred on the server.</response>
        [HttpPut]
        [Route("/v3/workorders/{workOrderId}/asset-tasks/end-all")]
        [ValidateModelState]
        [ProducesResponseType(statusCode: 401, type: typeof(SCServiceChannelServicesMessagingErrorResponse))]
        [ProducesResponseType(statusCode: 500, type: typeof(SCServiceChannelServicesMessagingErrorResponse))]
        public abstract Task<IActionResult> WorkordersworkOrderIdAssetTasksEndAll([FromRoute (Name = "workOrderId")][Required]int workOrderId);
        ...
        [ProducesResponseType(statusCode: 401, type: typeof(SCServiceChannelServicesMessagingErrorResponse))]
        [ProducesResponseType(statusCode: 500, type: typeof(SCServiceChannelServicesMessagingErrorResponse))]
        public abstract Task<IActionResult> WorkordersworkOrderIdAssetTasks_0([FromRoute (Name = "workOrderId")][Required]int workOrderId, [FromBody]SCServiceChannelServicesMessagingAssetTasksCreateAssetTaskResponseRequest request);
        ...
        /// <response code="500">Indicates that a generic error has occurred on the server.</response>
        [HttpGet]
        [Route("/v3/workorders/{workOrderId}/asset-tasks/{responseId}")]
        [ValidateModelState]
        [ProducesResponseType(statusCode: 401, type: typeof(SCServiceChannelServicesMessagingErrorResponse))]
        [ProducesResponseType(statusCode: 500, type: typeof(SCServiceChannelServicesMessagingErrorResponse))]
        public abstract Task<IActionResult> WorkordersworkOrderIdAssetTasksresponseId([FromRoute (Name = "workOrderId")][Required]int workOrderId, [FromRoute (Name = "responseId")][Required]int responseId);
        ...
        [ProducesResponseType(statusCode: 401, type: typeof(SCServiceChannelServicesMessagingErrorResponse))]
        [ProducesResponseType(statusCode: 500, type: typeof(SCServiceChannelServicesMessagingErrorResponse))]
        public abstract Task<IActionResult> WorkordersworkOrderIdAssetTasksresponseId_0([FromRoute (Name = "workOrderId")][Required]int workOrderId, [FromRoute (Name = "responseId")][Required]int responseId);
    }
}
