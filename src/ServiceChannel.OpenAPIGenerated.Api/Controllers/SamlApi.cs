...
{ 
    ...
    /// </summary>
    [ApiController]
    public abstract class SamlApiController : ControllerBase
    { 
        /// <summary>
        ...
        [HttpGet]
        [Route("/v3/saml/idpConfig")]
        [ValidateModelState]
        [ProducesResponseType(statusCode: 200, type: typeof(Object))]
        public abstract Task<IActionResult> SamlIdpConfigkeykey([FromQuery (Name = "key")][Required()]string key);
    }
}
