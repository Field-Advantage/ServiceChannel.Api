...
namespace ServiceChannel.Api.Test.Api
{
    ...
    public class RolesApiTests : IDisposable
    {
        ...
        /// </summary>
        [Fact]
        public void RolesFeedRolesTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.RolesFeedRoles();
            //Assert.IsType<List<SCServiceChannelServicesMessagingPrimaryRolesPrimaryRolesInfo>>(response);
        }
    }
}
