...
namespace ServiceChannel.Api.Test.Api
{
    ...
    public class CurrenciesApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test CurrenciesCurrencyalphabeticcodecurrencyIdcurrencyId
        /// </summary>
        [Fact]
        public void CurrenciesCurrencyalphabeticcodecurrencyIdcurrencyIdTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int currencyId = null;
            //var response = instance.CurrenciesCurrencyalphabeticcodecurrencyIdcurrencyId(currencyId);
            //Assert.IsType<SCServiceChannelServicesMessagingCurrenciesGetAlphabeticalCodeResponse>(response);
        }
    }
}
