...
{ 
    ...
    /// </summary>
    [DataContract]
    public class SCServiceChannelServicesMessagingAssetsUpdateAssetRequest : IEquatable<SCServiceChannelServicesMessagingAssetsUpdateAssetRequest>
    {
        /// <summary>
        ...
        public bool NeedUpdateParentId { get; set; } = false;
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SCServiceChannelServicesMessagingAssetsUpdateAssetRequest)obj);
        }

        /// <summary>
        /// Returns true if SCServiceChannelServicesMessagingAssetsUpdateAssetRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of SCServiceChannelServicesMessagingAssetsUpdateAssetRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SCServiceChannelServicesMessagingAssetsUpdateAssetRequest other)
        {
            ...
            return 
                ...
                (
                    NeedUpdateParentId == other.NeedUpdateParentId ||
                    
                    NeedUpdateParentId.Equals(other.NeedUpdateParentId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + NeedUpdateParentId.GetHashCode();
        ...
        public static bool operator ==(SCServiceChannelServicesMessagingAssetsUpdateAssetRequest left, SCServiceChannelServicesMessagingAssetsUpdateAssetRequest right)
        {
