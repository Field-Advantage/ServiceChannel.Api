...
{ 
    ...
    /// </summary>
    [DataContract]
    public class SCServiceChannelServicesMessagingFeedbackFeedbackReviewsForProviderResponse : IEquatable<SCServiceChannelServicesMessagingFeedbackFeedbackReviewsForProviderResponse>
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember(Name="TotalFilteredCount", EmitDefaultValue=true)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SCServiceChannelServicesMessagingFeedbackFeedbackReviewsForProviderResponse)obj);
        }

        /// <summary>
        /// Returns true if SCServiceChannelServicesMessagingFeedbackFeedbackReviewsForProviderResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of SCServiceChannelServicesMessagingFeedbackFeedbackReviewsForProviderResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SCServiceChannelServicesMessagingFeedbackFeedbackReviewsForProviderResponse other)
        {
            ...
            return 
                ...
                (
                    TotalFilteredCount == other.TotalFilteredCount ||
                    
                    TotalFilteredCount.Equals(other.TotalFilteredCount)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + TotalFilteredCount.GetHashCode();
        ...
        public static bool operator ==(SCServiceChannelServicesMessagingFeedbackFeedbackReviewsForProviderResponse left, SCServiceChannelServicesMessagingFeedbackFeedbackReviewsForProviderResponse right)
        {
