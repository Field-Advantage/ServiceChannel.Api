...
{ 
    ...
    /// </summary>
    [DataContract]
    public class SCServiceChannelServicesBrokerModelsContextsRequestBrokerWorkOrder : IEquatable<SCServiceChannelServicesBrokerModelsContextsRequestBrokerWorkOrder>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SCServiceChannelServicesBrokerModelsContextsRequestBrokerWorkOrder)obj);
        }

        /// <summary>
        /// Returns true if SCServiceChannelServicesBrokerModelsContextsRequestBrokerWorkOrder instances are equal
        /// </summary>
        /// <param name="other">Instance of SCServiceChannelServicesBrokerModelsContextsRequestBrokerWorkOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SCServiceChannelServicesBrokerModelsContextsRequestBrokerWorkOrder other)
        {
            ...
            return 
                (
                    OriginationUserName == other.OriginationUserName ||
                    OriginationUserName != null &&
                    OriginationUserName.Equals(other.OriginationUserName)
                ) && 
                (
                    Id == other.Id ||
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (OriginationUserName != null)
                    hashCode = hashCode * 59 + OriginationUserName.GetHashCode();
        ...
        public static bool operator ==(SCServiceChannelServicesBrokerModelsContextsRequestBrokerWorkOrder left, SCServiceChannelServicesBrokerModelsContextsRequestBrokerWorkOrder right)
        {
