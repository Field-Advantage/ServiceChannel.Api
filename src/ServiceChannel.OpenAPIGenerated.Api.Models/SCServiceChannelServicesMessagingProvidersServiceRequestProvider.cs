...
{ 
    ...
    /// </summary>
    [DataContract]
    public class SCServiceChannelServicesMessagingProvidersServiceRequestProvider : IEquatable<SCServiceChannelServicesMessagingProvidersServiceRequestProvider>
    {
        /// <summary>
        /// Rank
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SCServiceChannelServicesMessagingProvidersServiceRequestProvider)obj);
        }

        /// <summary>
        /// Returns true if SCServiceChannelServicesMessagingProvidersServiceRequestProvider instances are equal
        /// </summary>
        /// <param name="other">Instance of SCServiceChannelServicesMessagingProvidersServiceRequestProvider to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SCServiceChannelServicesMessagingProvidersServiceRequestProvider other)
        {
            ...
            return 
                ...
                (
                    ...
                    GeneralEmail != null &&
                    GeneralEmail.Equals(other.GeneralEmail)
                ) && 
                (
                ...
                (
                    ServiceRequestEmails == other.ServiceRequestEmails ||
                    ServiceRequestEmails != null &&
                    ServiceRequestEmails.Equals(other.ServiceRequestEmails)
                ) && 
                (
                    Phone == other.Phone ||
                    Phone != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + GeneralEmail.GetHashCode();
                    
                    hashCode = hashCode * 59 + IsDefault.GetHashCode();
                    if (ServiceRequestEmails != null)
                    hashCode = hashCode * 59 + ServiceRequestEmails.GetHashCode();
                    if (Phone != null)
        ...
        public static bool operator ==(SCServiceChannelServicesMessagingProvidersServiceRequestProvider left, SCServiceChannelServicesMessagingProvidersServiceRequestProvider right)
        {
