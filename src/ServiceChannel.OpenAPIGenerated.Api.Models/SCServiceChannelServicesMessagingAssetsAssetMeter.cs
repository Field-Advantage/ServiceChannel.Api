...
{ 
    ...
    /// </summary>
    [DataContract]
    public class SCServiceChannelServicesMessagingAssetsAssetMeter : IEquatable<SCServiceChannelServicesMessagingAssetsAssetMeter>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SCServiceChannelServicesMessagingAssetsAssetMeter)obj);
        }

        /// <summary>
        /// Returns true if SCServiceChannelServicesMessagingAssetsAssetMeter instances are equal
        /// </summary>
        /// <param name="other">Instance of SCServiceChannelServicesMessagingAssetsAssetMeter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SCServiceChannelServicesMessagingAssetsAssetMeter other)
        {
            ...
            return 
                ...
                (
                    MeterTypeName == other.MeterTypeName ||
                    MeterTypeName != null &&
                    MeterTypeName.Equals(other.MeterTypeName)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + MeterTypeName.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(SCServiceChannelServicesMessagingAssetsAssetMeter left, SCServiceChannelServicesMessagingAssetsAssetMeter right)
        {
