...
{ 
    ...
    /// </summary>
    [DataContract]
    public class SCServiceChannelServicesMessagingInvoicesInvoiceApprovalCode : IEquatable<SCServiceChannelServicesMessagingInvoicesInvoiceApprovalCode>
    {
        /// <summary>
        /// Gets or Sets Id
        /// </summary>
        ...
        /// </summary>
        [DataMember(Name="InvoiceChargeId", EmitDefaultValue=true)]
        ...
        /// </summary>
        [DataMember(Name="InternalParentId", EmitDefaultValue=true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SCServiceChannelServicesMessagingInvoicesInvoiceApprovalCode {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SCServiceChannelServicesMessagingInvoicesInvoiceApprovalCode)obj);
        }

        /// <summary>
        /// Returns true if SCServiceChannelServicesMessagingInvoicesInvoiceApprovalCode instances are equal
        /// </summary>
        /// <param name="other">Instance of SCServiceChannelServicesMessagingInvoicesInvoiceApprovalCode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SCServiceChannelServicesMessagingInvoicesInvoiceApprovalCode other)
        {
            ...
            return 
                ...
                (
                    InvoiceChargeId == other.InvoiceChargeId ||
                    
                    InvoiceChargeId.Equals(other.InvoiceChargeId)
                ) && 
                (
                ...
                (
                    InternalParentId == other.InternalParentId ||
                    
                    InternalParentId.Equals(other.InternalParentId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + InvoiceChargeId.GetHashCode();
                    ...
                    hashCode = hashCode * 59 + InternalParentId.GetHashCode();
        ...
        public static bool operator ==(SCServiceChannelServicesMessagingInvoicesInvoiceApprovalCode left, SCServiceChannelServicesMessagingInvoicesInvoiceApprovalCode right)
        {
