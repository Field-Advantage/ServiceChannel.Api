...
{ 
    ...
    /// </summary>
    [DataContract]
    public class SCSystemWebHttpResultsNegotiatedContentResultServiceChannelServicesMessagingInvoicesInvoicePaymentBulkResponse : IEquatable<SCSystemWebHttpResultsNegotiatedContentResultServiceChannelServicesMessagingInvoicesInvoicePaymentBulkResponse>
    {
        ...
        public List<SCSystemNetHttpFormattingMediaTypeFormatter> Formatters { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SCSystemWebHttpResultsNegotiatedContentResultServiceChannelServicesMessagingInvoicesInvoicePaymentBulkResponse)obj);
        }
        ...
        /// </summary>
        /// <param name="other">Instance of SCSystemWebHttpResultsNegotiatedContentResultServiceChannelServicesMessagingInvoicesInvoicePaymentBulkResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SCSystemWebHttpResultsNegotiatedContentResultServiceChannelServicesMessagingInvoicesInvoicePaymentBulkResponse other)
        {
            ...
            return 
                ...
                (
                    ContentNegotiator == other.ContentNegotiator ||
                    ContentNegotiator != null &&
                    ContentNegotiator.Equals(other.ContentNegotiator)
                ) && 
                (
                ...
                (
                    ...
                    Formatters != null &&
                    other.Formatters != null &&
                    Formatters.SequenceEqual(other.Formatters)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + ContentNegotiator.GetHashCode();
                    if (Request != null)
                    hashCode = hashCode * 59 + Request.GetHashCode();
                    if (Formatters != null)
                    hashCode = hashCode * 59 + Formatters.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(SCSystemWebHttpResultsNegotiatedContentResultServiceChannelServicesMessagingInvoicesInvoicePaymentBulkResponse left, SCSystemWebHttpResultsNegotiatedContentResultServiceChannelServicesMessagingInvoicesInvoicePaymentBulkResponse right)
        {
