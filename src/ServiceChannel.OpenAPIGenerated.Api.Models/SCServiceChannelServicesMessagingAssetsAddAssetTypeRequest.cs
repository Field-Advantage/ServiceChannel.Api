...
{ 
    ...
    /// </summary>
    [DataContract]
    public class SCServiceChannelServicesMessagingAssetsAddAssetTypeRequest : IEquatable<SCServiceChannelServicesMessagingAssetsAddAssetTypeRequest>
    {
        /// <summary>
        /// Gets or Sets ValidateTradeByName
        /// </summary>
        [DataMember(Name="ValidateTradeByName", EmitDefaultValue=true)]
        public bool ValidateTradeByName { get; set; } = false;

        /// <summary>
        /// Gets or Sets AllowAdditionalTradesOnInheritance
        /// </summary>
        [DataMember(Name="AllowAdditionalTradesOnInheritance", EmitDefaultValue=true)]
        public bool AllowAdditionalTradesOnInheritance { get; set; } = false;
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SCServiceChannelServicesMessagingAssetsAddAssetTypeRequest)obj);
        }

        /// <summary>
        /// Returns true if SCServiceChannelServicesMessagingAssetsAddAssetTypeRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of SCServiceChannelServicesMessagingAssetsAddAssetTypeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SCServiceChannelServicesMessagingAssetsAddAssetTypeRequest other)
        {
            ...
            return 
                (
                    ValidateTradeByName == other.ValidateTradeByName ||
                    
                    ValidateTradeByName.Equals(other.ValidateTradeByName)
                ) && 
                (
                    AllowAdditionalTradesOnInheritance == other.AllowAdditionalTradesOnInheritance ||
                    
                    AllowAdditionalTradesOnInheritance.Equals(other.AllowAdditionalTradesOnInheritance)
                ) && 
                (
                    Name == other.Name ||
                    Name != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + ValidateTradeByName.GetHashCode();
                    
                    hashCode = hashCode * 59 + AllowAdditionalTradesOnInheritance.GetHashCode();
                    if (Name != null)
        ...
        public static bool operator ==(SCServiceChannelServicesMessagingAssetsAddAssetTypeRequest left, SCServiceChannelServicesMessagingAssetsAddAssetTypeRequest right)
        {
